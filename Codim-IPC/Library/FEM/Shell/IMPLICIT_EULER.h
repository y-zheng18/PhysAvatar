    ...
    const std::string& outputFolder)
{
    ...
    do {
        ...
        printf("L2Norm %le: alpha = %le, feasibleAlpha = %le\n", L2Norm, alpha, feasibleAlpha);
        printf("useGD %d:", useGD);
        ...
        if (DBCStiff) {
            ...
            printf("penaltyCur %le, DBCPenaltyXn %le\n", penaltyCur, DBCPenaltyXn);
            ...
            // if(progress < 0.99) {
                ...
                T penaltyCur = 0;
                Compute_DBC_Dist2(X, DBC, penaltyCur);
                printf("penaltyCur %le", penaltyCur);
        ...
        // debug 
        // print L2Norm, NewtonTol, resRecord.size()
        printf("L2Norm %le, NewtonTol %le resRecord %d\n", L2Norm, NewtonTol, resRecord.size());
